...
if(is_post_request()){
    if(isset($_POST['hashtag']) && !empty($_POST['hashtag'])){
        ...
        if(substr($hashtag,0,1) === '#'){
            ...
            $trends = $loadFromPosts->getTrendByHash($trend);
            foreach($trends as $hashtag){
                echo '<li role="option" aria-selectable="true">
        ...
        if(substr($mention,0,1) === '@'){
            ...
            $mentions = $loadFromPosts->getMention($ment);
                    ...
                    <div class="ment-w-container">
                        ...
                        <div class="ment-profile-wrapper">
                            <div class="ment-profile-pic">
                                <img  src="'.$mention->profileImage.'" alt="'.$mention->firstName.' '.$mention->lastName.'" class="">
                            </div>
